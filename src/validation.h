 ...
 */
bool ProcessNewBlockHeaders(uint32_t& nPoSTemperature, const std::vector<CBlockHeader>& block, CValidationState& state, const CChainParams& chainparams, const CBlockIndex** ppindex=NULL);
