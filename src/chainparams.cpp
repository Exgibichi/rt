...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1386628033, 139946546, 0x1d00ffff, 1, 0);
...
public:
    CTestNetParams() {
        ...
        // emc insert correct value at 3rd argument
        genesis = CreateGenesisBlock(1386628033, 18330017, 0, 1, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
