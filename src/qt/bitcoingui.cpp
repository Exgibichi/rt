    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Emercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Emercoin address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Emercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Emercoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Emercoin Core help message to get a list with possible Emercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Emercoin Core client") + " " + networkStyle->getTitleAddText();
