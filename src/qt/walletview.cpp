    ...
    walletModel(0)
{
    ...
    // Pass through messages from manageNamesPage
//emercoin    connect(manageNamesPage, SIGNAL(message(QString,QString,unsigned int)), this, SIGNAL(message(QString,QString,unsigned int)));
}
