    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Emercoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Emercoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Emercoin Core is shutting down...") + "<br /><br />" +
